...
func DoWithCustom(ctx context.Context, fn func() error) error {
...
func DoWithResponse[T any](ctx context.Context, fn func() (T, error)) (T, error) {
	var lastErr error
	var result T
	...
	return result, fmt.Errorf("after 3 attempts: %w", lastErr)
}
